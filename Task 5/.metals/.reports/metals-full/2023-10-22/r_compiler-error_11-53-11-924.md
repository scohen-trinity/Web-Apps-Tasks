...
### file%3A%2F%2F%2FC%3A%2FUsers%2Fsammy%2FDownloads%2FWeb%2520Apps%2FTask%25205%2Fplay-tasks-scohen-trinity%2Fserver%2Ftest%2FMessageList1Spec.scala:16: error: ) expected but string constant found
            pwdField(id()"password").value = "prof"
                         ^
    ...
    "Message List 1" must {
        "login and access functions" in {
            ...
            eventually {
                ...
                pageTitle mustBe "MessageLists"
                println("Passed title")
                find(cssSelector("h2")).isEmpty mustBe false
                println("found h2")
